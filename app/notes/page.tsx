      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          {topNotes.length > 0 && (
            <section>
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-accent-mint/20 dark:bg-accent-mint/30 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7m0 0l7 7m-7-7v18" />
                  </svg>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Top Notes</h2>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">First impression • 15-30 minutes</p>
                </div>
              </div>
          ...
          {heartNotes.length > 0 && (
            <section>
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-accent-lavender/20 dark:bg-accent-lavender/30 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Heart Notes</h2>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Core character • 2-4 hours</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {baseNotes.length > 0 && (
            <section>
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-accent-rose/20 dark:bg-accent-rose/30 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                  </svg>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Base Notes</h2>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Lasting impression • 4-6+ hours</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
